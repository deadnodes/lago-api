...
DROP INDEX IF EXISTS public.index_contracts_invoice_custom_sections_on_contract_id;
...
--
-- Name: index_contracts_invoice_custom_sections_on_contract_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_contracts_invoice_custom_sections_on_contract_id ON public.contracts_invoice_custom_sections USING btree (contract_id);
